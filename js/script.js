...
document.addEventListener("DOMContentLoaded", () => {
  const destinations = [
    {
      city: "València",
      playa: { title: "Playa de Pinedo", description: "Una playa cercana al centro de <b>València</b> donde las mascotas pueden disfrutar del mar y la arena.", location: "<a href='https://maps.app.goo.gl/CqApL9iM5hoUw5TD9' class='link'>Playa de Pinedo</a>" },
    ...
    {
      city: "Roma",
      playa: { title: "Association Baubeach Village", description: "Una playa perfecta para mascotas, equipada con duchas, sombra y espacios para correr.", location: "<a href='https://maps.app.goo.gl/9hjKgfwGo23CUmmW6' class='link'>Via di Praia a Mare</a>" },
      hotel: { title: "Hotel Cavalieri Waldorf Astoria", description: "Un hotel de lujo en Roma que ofrece camas, paseos y menús especiales para mascotas.", location: "<a href='https://maps.app.goo.gl/CvEV8zdiyv7qnNJ59' class='link'>Via Alberto Cadlolo, 101</a>" },
      cafeteria: { title: "Fiuto Restaurant", description: "El primer restaurante de Italia donde los dueños y sus mascotas pueden ya sentarse en la misma mesa y degustar un menú ideado para ambos.", location: "<a href='https://maps.app.goo.gl/a8fc8FVPX3EWMD9y7' class='link'>Via Flaminia, 498/500 - 502</a>" },
    },
    {
      city: "Venecia",
      playa: { title: "Paseos en los canales junto a la isla Lido", description: "Disfruta de un paseo tranquilo junto a tu mascota por las áreas menos concurridas del Lido.", location: "<a href='https://maps.app.goo.gl/yZpbPHNkgsvH9UVj8' class='link'>Lido de Venecia</a>" },
      hotel: { title: "Hotel Ai Reali", description: "Un hotel lujoso que recibe a las mascotas con camas y cuidados especiales en pleno centro de Venecia.", location: "<a href='https://maps.app.goo.gl/tisgmt1kb48GmZ8o9' class='link'>Calle Seconda de la Fava, 5527</a>" },
      cafeteria: { title: "Café Torrefazione Cannaregio", description: "Una cafetería pet-friendly famosa por su café artesanal y un espacio cómodo para descansar.", location: "<a href='https://maps.app.goo.gl/XqDiraeZfXAWfcjL8' class='link'>Fondamenta dei Ormesini, 2804</a>" },
    },
    {
      city: "Milán",
      playa: { title: "Parque Sempione", description: "El parque más famoso de Milán, ideal para pasear con tu mascota junto al lago y zonas verdes.", location: "<a href='https://maps.app.goo.gl/dgF1uckDFoaaqgE57' class='link'>20121 Milan, Metropolitan City of Milan</a>" },
      hotel: { title: "Hotel Principe di Savoia", description: "Un hotel de lujo que ofrece paquetes especiales y camas VIP para mascotas.", location: "<a href='https://maps.app.goo.gl/JBVZKTg1geWFBxmN8' class='link'>Piazza della Repubblica, 17</a>" },
      cafeteria: { title: "Café Panini Durini", description: "Una cadena de cafeterías pet-friendly perfecta para disfrutar de un desayuno o aperitivo con tu mascota.", location: "<a href='https://maps.app.goo.gl/ULdb1k6G4S5k44Tt8' class='link'>Via Durini, 26</a>" },
    },
    {
      city: "Berlín",
      playa: { title: "Lago Wannsee", description: "Un lugar tranquilo donde puedes pasear y nadar con tu mascota en una zona dedicada a los perros.", location: "<a href='https://maps.app.goo.gl/XxRPcRYLRN7PFQm39' class='link'>Wannsee, Berlín</a>" },
      hotel: { title: "Hotel Michelberger", description: "Un hotel pet-friendly con un estilo único y acogedor que ofrece comodidad para ti y tu mascota.", location: "<a href='https://maps.app.goo.gl/PpYTVdDUaJnsqe6M6' class='link'>Warschauer Str. 39-40</a>" },
      cafeteria: { title: "Fellfreunde Unser Hundecafe", description: "Un café especialmente diseñado para mascotas con snacks saludables y espacios al aire libre.", location: "<a href='https://maps.app.goo.gl/NiRVp1NeMoNvXzvv7' class='link'>Beuthstraße 41</a>" },
    },
    {
      city: "Múnich",
      playa: { title: "Englischer Garten", description: "Un extenso parque con ríos y lagos donde las mascotas pueden pasear y refrescarse en el agua.", location: "<a href='https://maps.app.goo.gl/ntjsmNo17EdfDWN49' class='link'>Jardín Inglés de Múnich</a>" },
      hotel: { title: "Hotel Vier Jahreszeiten Kempinski", description: "Un hotel elegante que admite mascotas con atención especial y menús exclusivos para ellas.", location: "<a href='https://maps.app.goo.gl/HeHN7p8Las6rkhLR7' class='link'>Maximilianstraße 17</a>" },
      cafeteria: { title: "Café Katzentempel", description: "Una cafetería temática donde las mascotas son bienvenidas y se ofrecen snacks vegetarianos.", location: "<a href='https://maps.app.goo.gl/W29q3nmH4BEDAkr2A' class='link'>Türkenstraße 29</a>" },
    },
    {
      city: "Valencia",
      playa: { title: "Playa La Rosa", description: "Un espacio verde amplio con senderos perfectos para pasear con tu mascota.", location: "<a href='https://maps.app.goo.gl/Bupa3nJ3VPB8DWw27' class='link'>Puerto Cabello 2050, Carabobo</a>" },
      hotel: { title: "Hesperia WTC Valencia", description: "Un hotel pet-friendly con áreas para caminar con tu mascota y servicios dedicados.", location: "<a href='https://maps.app.goo.gl/kTNi2SFk7uFgyN3L9' class='link'>Naguanagua, Av. 168 Salvador Feo La Cruz Este-Oeste</a>" },
      cafeteria: { title: "Nautilus Jardín Gourmet", description: "Un lugar acogedor con terraza para disfrutar de un buen café acompañado de tu mascota.", location: "<a href='https://maps.app.goo.gl/msZazrqcy6dD9LNZ6' class='link'>Calle 148, Valencia</a>" },
    },
    {
      city: "Caracas",
      playa: { title: "Parque Generalísimo Francisco de Miranda", description: "Un enorme parque con lagos y amplios espacios verdes ideales para pasear con tu mascota.", location: "<a href='https://maps.app.goo.gl/1pgdS8CB1LANdwtCA' class='link'>Avenida Francisco de Miranda</a>" },
      hotel: { title: "Hotel Renaissance Caracas La Castellana", description: "Un hotel pet-friendly con instalaciones modernas y áreas cercanas para pasear a tu mascota.", location: "<a href='https://maps.app.goo.gl/WQDfNykHci7edJZK9' class='link'>Ave Eugenio Mendoza, Con Calle Urdaneta</a>" },
      cafeteria: { title: "MANVÄ Natural Market", description: "Una cafetería con terrazas cómodas donde las mascotas son bien recibidas mientras disfrutas de un buen café.", location: "<a href='https://maps.app.goo.gl/BhunKXaZ4HY6Mc2F6' class='link'>planta baja, Calle Miranda edificio Elvira, Local 5 Chacao</a>" },
    },
    {
      city: "Ciudad de México",
      playa: { title: "Parque Naucalli", description: "Un icónico parque pet-friendly con áreas verdes, fuentes y zonas dedicadas a perros.", location: "<a href='https://maps.app.goo.gl/DjkNssZrvGj5h66Z6' class='link'>Manzana 020, 53150 Naucalpan de Juárez</a>" },
      hotel: { title: "Hotel Stara Hamburgo", description: "Un hotel boutique que ofrece comodidades para mascotas como camas especiales y snacks.", location: "<a href='https://maps.app.goo.gl/66RQijpFvmh9R1kb9' class='link'>Hamburgo 32, Juárez, Cuauhtémoc</a>" },
      cafeteria: { title: "Moahu Café", description: "Una cafetería con un ambiente relajado y pet-friendly donde puedes leer acompañado de tu mascota.", location: "<a href='https://maps.app.goo.gl/RmCaoPA2wgPNgUGA8' class='link'>Museo 188-Loc C, San Pedro, San Pablo Tepetlapa, Coyoacán</a>" },
    },
    {
      city: "Cancún",
      playa: { title: "Playa Coral (Mirador II)", description: "Una playa oficialmente pet-friendly con acceso directo al mar Caribe para que tu mascota disfrute.", location: "<a href='https://maps.app.goo.gl/Ct6ZNPS8VGVBstxd8' class='link'>Punta Nizuc - Cancún 700</a>" },
      hotel: { title: "Hotel Imperial Laguna Faranda Cancún", description: "Un hotel especializado en recibir a mascotas con áreas cercanas para jugar y caminar.", location: "<a href='https://maps.app.goo.gl/HAVJ1E3aNRyxQ9JR7' class='link'>77510, Quetzal 17, Zona Hotelera</a>" },
      cafeteria: { title: "Onesto Café", description: "Una cafetería famosa en Cancún con un ambiente tranquilo y terrazas aptas para mascotas.", location: "<a href='https://maps.app.goo.gl/CYXGKQJSSRknirA1A' class='link'>Av Carlos Nader 6</a>" },
    },
    {
      city: "Miami",
      playa: { title: "Haulover Beach Dog", description: "Una playa pet-friendly donde tu perro puede correr libremente en la arena y nadar en el océano.", location: "<a href='https://maps.app.goo.gl/34nEfdUuAL99isaFA' class='link'>10801 Collins Ave, Bal Harbour</a>" },
      hotel: { title: "Kimpton EPIC Hotel", description: "Un hotel de lujo que ofrece camas, platos y servicios VIP para mascotas.", location: "<a href='https://maps.app.goo.gl/jLisu5rDBzoW7jVAA' class='link'>270 Biscayne Blvd Way</a>" },
      cafeteria: { title: "Panther Coffee - Wynwood", description: "Una cafetería con terrazas al aire libre perfecta para disfrutar un café junto a tu mascota.", location: "<a href='https://maps.app.goo.gl/KZARZvhLbXRAgduV9' class='link'>2390 NW 2nd Ave</a>" },
    },
    {
      city: "Nueva York",
      playa: { title: "Rockaway Beach", description: "Una playa famosa en Nueva York donde las mascotas pueden disfrutar del mar.", location: "<a href='https://maps.app.goo.gl/hoRQQ1xU4ytczro37' class='link'>Rockaway Beach Boardwalk, Arverne</a>" },
      hotel: { title: "The William Vale", description: "Un hotel moderno en Brooklyn que consiente a las mascotas con camas especiales y amenidades personalizadas.", location: "<a href='https://maps.app.goo.gl/Ksuj49cnaphDc6sn9' class='link'>111 N 12th St, Brooklyn</a>" },
      cafeteria: { title: "Boris & Horton", description: "Un café icónico en Nueva York donde las mascotas son tan bienvenidas como los humanos.", location: "<a href='https://maps.app.goo.gl/wuhe5rWgeNWYzm7m8' class='link'>195 Avenue A</a>" },
    },
    {
      city: "San Francisco",
      playa: { title: "Playa de Crissy Field", description: "Un lugar emblemático con vistas al Golden Gate donde las mascotas pueden correr libremente junto al mar.", location: "<a href='https://maps.app.goo.gl/xM3G5j1DK7mt7tSe8' class='link'>San Francisco, CA</a>" },
      hotel: { title: "Hotel Argonaut", description: "Un hotel boutique frente a la bahía que recibe a tus mascotas con comodidades y snacks especiales.", location: "<a href='https://maps.app.goo.gl/262rqaujtEbtHSEp6' class='link'>495 Jefferson St</a>" },
      cafeteria: { title: "Andytown Coffee Roasters", description: "Un lugar ideal para tomar un café mientras tu mascota se relaja junto a ti en la terraza.", location: "<a href='https://maps.app.goo.gl/B7VYm1MJY31zfM2C8' class='link'>Rooftop, Park Level, 181 Fremont St</a>" },
    },
    {
      city: "Tokio",
      playa: { title: "Playa de Kawasaki", description: "Una playa para pasear y relajarse junto al agua, donde las mascotas son bienvenidas. Hay amplios espacios verdes y senderos para explorar.", location: "<a href='https://maps.app.goo.gl/dTbDrqizkRf1EQAH8' class='link'>58-1 Higashiogishima, Kawasaki Ward</a>" },
      hotel: { title: "Hotel Kimpton Shinjuku Tokyo", description: "Un hotel de lujo que ofrece servicios exclusivos para mascotas, como camas y menús especiales.", location: "<a href='https://maps.app.goo.gl/okeq8sT3aySd99an7' class='link'>3 Chome-4-7 Nishishinjuku, Shinjuku City</a>" },
      cafeteria: { title: "Deco`s Dog Cafe countryside Sabo", description: "Una cafetería temática pet-friendly donde las mascotas son el centro de atención.", location: "<a href='https://maps.app.goo.gl/Xry3GKX4uPWdT26X8' class='link'>Japón, 〒145-0071 Tokyo, Ota City, Denenchofu, 2 Chome−62−1</a>" },
    },
    {//A PARTIR DE AQUI
      city: "Osaka",
